...
def run_imbalance(from_date : date,to_date : date):
    ...
    while (imbalance_date <= to_date):
        ...
        insert_raw("elexon_raw",imbalance["ingested_utc"],imbalance["payload"],"imbalance")
...
def run_market_index(from_dt : datetime, to_dt : datetime):
    ...
    insert_raw("elexon_raw",market_index["ingested_utc"],market_index["payload"],"market-index")
