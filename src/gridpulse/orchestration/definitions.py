...
# Staging is materialized as views and needs no rebuilding, so refreshing the marts
# alone skips the tests against the 15m row regional view: 93 seconds against 1,967.
